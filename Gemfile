...
# Use Rack CORS para lidar com o compartilhamento de recursos de origem cruzada (CORS), tornando possível o Ajax de origem cruzada
# gem "rack-cors"
...
group :development, :test do
  ...
  # Estilo Omakase Ruby [https:/benchmark/github.com/rails/rubocop-rails-omakase/]
